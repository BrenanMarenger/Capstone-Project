...
<div class="body" v-if="watchAgainVideos.length > 0">
    ...
    <div class="watch-again-container"> 
        <div class="side-buttons" v-if="watchAgainVideos.length > 7">
                <svg 
                class="left-arrow" 
                @click="scrollLeft"
        ...
        <div class="slider" id="slider">
            <div v-for="video in watchAgainVideos" :key="video.Path" class="watch-again-item">
                    ...
                    <div class="watch-again-controls">
                        ...
                        <router-link 
                            class="play" 
                            :to="{name: 'display', params: {videoId: video.id}, query: { time: video.Spot }}" 
                            tag="button">
                        ...
                        <button 
                            class="fav" 
                            @click="sendToggleFavorite(video)" 
                            v-if="favoritesId.includes(video.id)">
...
.watch-again-item:hover .watch-again-controls{
    transition: all .5s ease-in-out;
    display: block;
    filter: drop-shadow(2px 2px 4px black);
}
...
.watch-again-container:hover .side-buttons .left-arrow, 
.watch-again-container:hover .side-buttons .right-arrow{
    opacity: .6;
    transition: all .3s ease-in-out;
}
.left-arrow{
